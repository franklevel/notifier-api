...
export class Database1711463871478 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            INSERT INTO notifier_db.user (id, name, email, phoneNumber, deviceToken) VALUES
            ...
            INSERT INTO notifier_db.category (id, name) VALUES
            ...
            INSERT INTO notifier_db.channel (id, name) VALUES
            ...
            INSERT INTO notifier_db.user_subscribed_categories_category (userId, categoryId) VALUES
            ...
            INSERT INTO notifier_db.user_notification_channels_channel (userId, channelId) VALUES
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            ...
            DELETE FROM notifier_db.user_notification_channels_channel;
            DELETE FROM notifier_db.user;
            DELETE FROM notifier_db.category;
            DELETE FROM notifier_db.channel;
        `);
    }
